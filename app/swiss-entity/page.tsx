        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <ScrollReveal delay={200}>
            <p className="text-gray-500">
              Unlike corporations, associations are formed through member agreements rather than public filings. This means your team maintains control and privacy while gaining the legal protections of a formal entity. The legal setup process is supported by <a href="https://www.mme.ch/en/" target="_blank" rel="noopener noreferrer" className="text-[rgb(122,58,255)] hover:underline">MME</a>, a leading Swiss law firm specializing in digital and blockchain-native organizations.
            </p>
          </ScrollReveal>
        </div>
      </section>
