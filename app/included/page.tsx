      ...
      <section className="border-t border-gray-200 bg-[rgb(122,58,255)]/5">
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <ScrollReveal animation="slide-right" className="flex-1">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <ScrollReveal delay={0}>
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 hover:shadow-md hover:border-gray-300 transition-all h-full">
